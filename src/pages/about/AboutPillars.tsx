  ...
  return (
    <section className="py-10 bg-slate-950 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-0 w-200 h-200 rounded-full bg-[#28A8E0]/10 blur-[150px] pointer-events-none"
      />
      <motion.div
        animate={{
        ...
        className="absolute bottom-1/4 right-0 w-200 h-200 rounded-full bg-[#F8C000]/5 blur-[150px] pointer-events-none"
      />
        ...
        <div className="hidden lg:flex gap-4 h-[580px] w-full overflow-hidden">
          {pillars.map((pillar, i) => {
            ...
            const flexClass = isHovered 
              ? 'flex-[2.8] border-[#28A8E0]/40 shadow-2xl' 
              : isAnyHovered 
            ...
            return (
              ...
              >
                ...
                <div className="relative z-20 w-full flex flex-col items-start transition-all duration-500">
                  ...
                  <div className="absolute top-[-380px] right-0 select-none text-7xl font-black text-white/5 group-hover:text-[#28A8E0]/15 transition-colors duration-500">
                    {pillar.id}
                  </div>
                  ...
                  {/* Pillar Number Label */}
                  <span className="text-xs font-bold uppercase tracking-widest text-[#28A8E0] mb-2">
                    Pillar {pillar.id}
                  </span>
                  ...
                  <div
                    className={`transition-all duration-700 ease-in-out overflow-hidden ${
                      isHovered ? 'max-h-[180px] opacity-100 mt-3' : 'max-h-0 opacity-0'
                    }`}
                  >
                    ...
                    <div className="flex items-center gap-2 text-[#28A8E0] text-xs font-bold uppercase tracking-wider">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-linear-to-r from-transparent via-[#28A8E0] to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
              </div>
            )
          })}
        </div>
          ...
          {pillars.map((pillar, i) => {
            ...
            return (
              <motion.div
                ...
                key={pillar.id}
                className="relative rounded-3xl overflow-hidden border border-white/10 bg-slate-900 flex flex-col justify-end p-8 min-h-[360px] group shadow-xl"
              >
                {/* Background Image */}
                <div className="absolute inset-0 z-0 overflow-hidden">
                  <img
                  ...
                  />
                  {/* Tailwind CSS v4 gradient overlay */}
                  <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-slate-950/70 to-transparent opacity-90 z-10" />
                </div>

                {/* Content */}
                <div className="relative z-10">
                  <div className={`inline-flex p-3 rounded-xl border bg-slate-950/80 backdrop-blur-md mb-4 ${pillar.color}`}>
