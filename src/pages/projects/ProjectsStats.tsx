          ...
          {stats.map((stat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="px-4 sm:px-6 flex flex-col items-center py-6 sm:py-4 lg:py-0 first:pt-0 last:pb-0"
              >
                {/* Icon */}
                ...
                <div className="flex items-baseline justify-center mb-1">
                  ...
                  />
                  <span className="text-base sm:text-lg font-black text-slate-800 ml-1">
                    {stat.suffix}
                  </span>
                </div>

                {/* Label */}
                <h4 className="text-xs font-black uppercase tracking-wider text-[#1B74BB] mb-1">
                  {stat.label}
                </h4>

                {/* Description */}
                <p className="text-[11px] text-slate-900 font-semibold max-w-[200px] leading-relaxed">
                  {stat.description}
                </p>
              </motion.div>
            )
