...
export default function ServiceHero({ title, heroSubtitle, heroImage }: ServiceHeroProps) {
  ...
  return (
    <div className="relative bg-[#020813] text-white pt-32 pb-24 overflow-hidden border-b border-slate-900">
      ...
      <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-[#004093]/15 blur-[130px] pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-[#FE9900]/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black font-serif leading-tight text-white tracking-tight">
              {title}
            </h1>

            <p className="text-sm md:text-base text-slate-300 font-semibold leading-relaxed max-w-2xl">
              {heroSubtitle}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-bold text-slate-200 border-t border-white/5 pt-6">
            <div className="flex items-start gap-2.5">
              <CheckCircle2 className="w-4.5 h-4.5 text-[#FE9900] shrink-0 mt-0.5" />
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
            <button
              ...
              className="bg-[#FE9900] hover:bg-[#ffaa22] text-black font-black text-xs uppercase tracking-wider px-8 py-4 rounded-xl transition-all duration-200 text-center shadow-lg shadow-[#FE9900]/10 cursor-pointer border-none"
            >
              Get Free Assessment
            </button>
        ...
        <div className="lg:col-span-4 flex justify-center lg:justify-end">
          <div className="bg-slate-950/60 backdrop-blur-md border border-white/10 p-6 rounded-2xl max-w-sm w-full space-y-4 shadow-2xl relative overflow-hidden">
            {/* Background blur */}
            <div className="absolute top-0 right-0 w-24 h-24 bg-[#FE9900]/10 blur-xl pointer-events-none" />
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-350 font-semibold">Speak to a certified engineer today.</p>
              </div>
            </div>
            ...
            <a
              href="tel:1300672194"
              className="relative z-10 block text-center bg-white hover:bg-[#FE9900] hover:text-black text-[#004093] font-black py-2.5 rounded-xl transition text-xs uppercase tracking-wider shadow-md"
            >
              Call 1300 672 194
            </a>
          </div>
