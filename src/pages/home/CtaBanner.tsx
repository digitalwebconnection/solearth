...
export default function CtaBanner() {
  ...
  return (
    <section className="py-16 bg-linear-to-r from-[#FCC200] to-[#e6af00]">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 shrink-0">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-white text-[#FCC200] font-extrabold px-8 py-4 rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-0.5 text-base"
            >
