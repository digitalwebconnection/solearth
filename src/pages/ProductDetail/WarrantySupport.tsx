        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-6 gap-6 md:gap-8 max-w-7xl mx-auto">
          {product.warranty.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative bg-slate-50/50 p-8 rounded-b-lg shadow-lg shadow-black border border-slate-200/60 hover:bg-white hover:border-[#004093]/20 hover:shadow-xl hover:shadow-[#004093]/5 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between min-h-[220px] cursor-default"
              >
                {/* Horizontal Indicator accent line */}
                <div className="absolute top-0 left-0 right-0 h-[3px] bg-[#FE9900] rounded-t-3xl scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
                ...
                <div className="space-y-2 pt-6">
                  <div className="flex items-center gap-2">
                    <BadgeCheck size={14} className="text-[#004093]" />
        ...
        <div className="relative bg-slate-50/50 p-8 rounded-3xl border border-slate-200/40 overflow-hidden max-w-7xl mx-auto">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-2 max-w-6xl">
              ...
              <p className="text-slate-800 text-base md:text-lg italic font-bold leading-relaxed">
